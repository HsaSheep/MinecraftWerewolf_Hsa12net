...
役職タグなしの人、タグ消しコマンド追加 -> 暫定的に役職部屋テレポート時に消すように変更。出来れば役職タグ設定にmadmanとseer消すコマンドつけたい…？
...
{Rotation:[-90f,0f],Tags:["shop"],Profession:3,CustomName:"武器商人",Career:2,CareerLevel:42,CanPickUpLoot:0,PersistenceRequired:1,NoAI:1,Silent:1,Invulnerable:1,Attributes:[
    ...
    Offers:{Recipes:[
        ...
        {buy:{id:"minecraft:emerald",Count:2},maxUses:9999999,sell:{id:"minecraft:arrow",Count:1},rewardExp:false},
...
{Rotation:[-90f,0f],Tags:["shop"],Profession:1,CustomName:"雑貨商人",Career:2,CareerLevel:42,CanPickUpLoot:0,PersistenceRequired:1,NoAI:1,Silent:1,Invulnerable:1,Attributes:[
    ...
    Offers:{Recipes:[
        {buy:{id:"minecraft:emerald",Count:1},maxUses:9999999,sell:{id:"minecraft:cooked_beef",Count:5},rewardExp:false},
        {buy:{id:"minecraft:emerald",Count:4},maxUses:9999999,sell:{id:"minecraft:nether_star",Count:1,tag:{display:{Name:"割るだけ簡単！不死身1Dayタイプ",Lore:["村人用アイテム。狂人は使えない。","手にもって右クリックで使用する。","夜の間しか使えず、翌日まで効果がある。","いったいどんな仕組みなんだろう…？"]}}},rewardExp:false},
        ...
        {buy:{id:"minecraft:emerald",Count:5},maxUses:9999999,sell:{id:"minecraft:bone",Count:1,tag:{display:{Name:"人狼への贈り物",Lore:["狂人が使用するアイテム。","右クリックで使用。","使った狂人と人狼は","お互いの名前が表示される。","これ何でできてるん…？"]}}},rewardExp:false}
        ]}}
